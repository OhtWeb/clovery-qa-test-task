...
А. Коллекция Postman со списком E2E запросов и набором тестов

B. .csv-файл для прогона коллекции Postman

C. Clovery_methods.py и Clovery_tests_py - методы POST и GET и тесты к ним

D. Тестовое задание для QA-инженеров (13-поток).pdf

E. Содержимое пункта C в текстовом виде:
...
4. Какие исключительные ситуации бы обрабатывали?
...
6. Какими инструментами бы воспользовались?
7. 
...
9. Какие улучшения бы предложили внести программистам в работу метода, чтобы повысить информативность тестирования?
10. 
